...
-- -----------------------------------------------------
-- Table `mydb`.`PontoInteresse_has_Admin`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`PontoInteresse_has_Admin` (
  `PontoInteresse_nome` VARCHAR(25) NOT NULL,
  `Admin_email` VARCHAR(25) NOT NULL,
  PRIMARY KEY (`PontoInteresse_nome`, `Admin_email`),
  INDEX `fk_PontoInteresse_has_Admin_Admin1_idx` (`Admin_email` ASC) VISIBLE,
  INDEX `fk_PontoInteresse_has_Admin_PontoInteresse1_idx` (`PontoInteresse_nome` ASC) VISIBLE,
  CONSTRAINT `fk_PontoInteresse_has_Admin_PontoInteresse1`
    FOREIGN KEY (`PontoInteresse_nome`)
    REFERENCES `mydb`.`PontoInteresse` (`nome`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PontoInteresse_has_Admin_Admin1`
